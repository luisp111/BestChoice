        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              ...
              estimate, or to discuss your flooring project.
            </p>
          </div>
        </div>
      </section>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-700 focus:border-transparent"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-700 focus:border-transparent"
                    placeholder="Tell us about your project, room dimensions, timeline, or any specific requirements..."
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full bg-amber-700 hover:bg-amber-800 disabled:bg-amber-300 text-white font-bold py-3 px-6 rounded-lg text-lg transition-colors"
                >
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">(971) 219-1246</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">info@bestchoiceflooring.com</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">Local metropolitan area</p>
                      <p className="text-sm text-slate-500">Free estimates within 30 miles</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-50 p-8 rounded-lg">
                ...
                <ul className="space-y-2 text-slate-700">
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span>Warranty on all installations</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-slate-800 mb-4">Our Service Area</h2>
            <p className="text-xl text-slate-600">
              We proudly serve the local metropolitan area with quality flooring solutions
            </p>
          </div>
          ...
          <div className="bg-slate-200 h-96 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-slate-500">Currently serving: Downtown, Midtown, Suburbs</p>
            </div>
          </div>
        </div>
      </section>
