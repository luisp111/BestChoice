            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-amber-500 hover:bg-amber-600 disabled:bg-amber-300 text-white font-bold py-3 px-6 rounded-lg text-lg transition-colors"
                >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@bestchoiceflooring.com</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Local metropolitan area</p>
                      <p className="text-sm text-gray-500">Free estimates within 30 miles</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-200 h-96 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-500">Currently serving: Downtown, Midtown, Suburbs</p>
            </div>
          </div>
        </div>
      </section>
